...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/16 15:06:23 by mbanani           #+#    #+#             */
/*   Updated: 2018/11/08 16:32:46 by mbanani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_strjoinlen(const char *s1, const char *s2, size_t c);
char				*ft_strpbrk(const char *s, const char *charest);
size_t				ft_strcspn(const char *s1, const char *s2);
size_t				ft_words_len(const char *s1, char c);
...
char				*ft_strsubchar(char const *s, unsigned int start,
		size_t len, char ch);
